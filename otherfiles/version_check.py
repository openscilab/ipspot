...
SETUP_ITEMS = [
    "version='{0}'",
    "https://github.com/openscilab/ipspot/tarball/v{0}"]

CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/ipspot/compare/v{0}...dev",
    "[{0}]:"]

PARAMS_ITEMS = ['IPSPOT_VERSION = "{0}"']
ISSUE_TEMPLATE_ITEMS = ["- IPSpot {0}"]
